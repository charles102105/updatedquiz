...
<div class="quiz-container">
    ...
    <form action="q8.php" method="post">
        <img src="images/html.jpg" alt="HTML Logo" class="question-image">

        <div class="question-text">
            8. HTML is a programming language?
        </div>

        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="a" name="q8" required>
                A. True
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="b" name="q8" required>
                B. False
            </label>
        </div>
