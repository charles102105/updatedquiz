...
<div class="quiz-container">
    ...
    <form action="q3.php" method="post">
        <img src="images/ram.jpg" alt="RAM Image" class="question-image">

        <div class="question-text">
            3. What is the name of this part?
        </div>

        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="a" name="q3" required>
                A. SSD
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="b" name="q3" required>
                B. PSU
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="c" name="q3" required>
                C. CPU
            </label>
        </div>
        <div class="mb-4">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="d" name="q3" required>
                D. RAM
            </label>
        </div>
