...
<div class="quiz-container">
    ...
    <form action="q2.php" method="post">
        <img src="images/cpu.jpg" alt="CPU Image" class="question-image">
        ...
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="a" name="q2" required>
                A. Central Process Unit
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="b" name="q2" required>
                B. Central Processing Unit
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="c" name="q2" required>
                C. Control Processing Unit
            </label>
        </div>
        <div class="mb-4">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="d" name="q2" required>
