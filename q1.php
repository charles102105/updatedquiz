...
<div class="quiz-container">
    ...
    <form action="q1.php" method="post">
        <img src="images/squarebrackets.png" alt="Square Brackets Symbol" class="question-image">
        ...
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="a" name="q1" required>
                A. Angle Brackets
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="b" name="q1" required>
                B. Curly Brackets
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="c" name="q1" required>
                C. Round Brackets
            </label>
        </div>
        <div class="mb-4">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="d" name="q1" required>
                D. Square Brackets
            </label>
        </div>
