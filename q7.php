...
<div class="quiz-container">
    ...
    <form action="q7.php" method="post">
        <img src="images/javascript.png" alt="JavaScript Logo" class="question-image">

        <div class="question-text">
            7. JavaScript can be used to build websites?
        </div>

        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="a" name="q7" required>
                A. True
            </label>
        </div>
        <div class="mb-3">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" value="b" name="q7" required>
                B. False
            </label>
        </div>
